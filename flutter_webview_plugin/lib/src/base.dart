...
class FlutterWebviewPlugin {
  ...
  final _javascriptChannelMessage = StreamController<JavascriptChannel>.broadcast();
  ...
  Future<Null> _handleMessages(MethodCall call) async {
    switch (call.method) {
      ...
      case "javascriptChannelMessage":
        _javascriptChannelMessage.add(JavascriptChannel.fromJson(call.arguments));
        break;
      case 'onState':
        _onStateChanged.add(
  ...
  Stream<JavascriptChannel> get onJavascriptChannelMessage => _javascriptChannelMessage.stream;
  ...
  Future<Null> launch(String url, {
    ...
    final args = <String, dynamic>{
      ...
      'javascriptChannelNames': javascriptChannels ?? [],
    };
  ...
  void dispose() {
    ...
    _onHttpError.close();
    _javascriptChannelMessage.close();
    _instance = null;
  }
...
class JavascriptChannel {
  ...
  static JavascriptChannel fromJson(Map json){
    JavascriptChannel javascriptChannel = new JavascriptChannel();
    javascriptChannel.channelName = json["channel"];
    javascriptChannel.message = json["message"];
